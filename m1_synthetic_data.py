...
try:
    ...
    # Générer en respectant la distribution du label (95% solvable, 5% à risque)
    n_total  = 20000
    n_risque = int(n_total * 0.05)   # ~1 000 clients à risque
    ...
    try:
        ...
        from sdmetrics.single_table import GaussianCopulaSynthesizer
